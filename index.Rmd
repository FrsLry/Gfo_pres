...
<br>
.center[**At which time span should we survey biodiversity?**]
...
* For North American birds, larger spatial scales seem to increase positively the species richness (Chase *et al* 2019)
<br>

--------

* Temporal dissimilarity and turnover, extinction and colonization seem to decrease with increasing spatial scales (Jarzyna *et al.* 2015)
]
...
What are the links between biodiversity dynamic and spatio-temporal scales?

--


<br><br><br>
<b>Taxon:</b> Birds (many surveys by ornithologists for a long time, well identified, able to move after perturbations...)

<b>Location:</b> At first Czech Republic, then western Europe, north America...

<b>Methods:</b> Machine learning approaches such as Random Forests (RF) or Boosted Regression Trees (BRT)
...
Use heterogeneous avian biodiversity datasets to model species richness dynamic across continuums of space and time scales
...
.pull-right[
Spatial scales ranging from less than 100 Km $^2$ to more than 80 000 Km $^2$ (the entire Czech Republic)
]
...
* 3 time periods (M2, M3 and M4 of the Atlas dataset)

* Harmonization with JPSP datasets: choosing 3 time periods the closest to the Atlas ones
...
```{r, out.width="95%"}
knitr::include_graphics('../phd/docs/phd_files/figure-html/unnamed-chunk-30-1.png')
```
...
```{r, out.width="95%"}
knitr::include_graphics("../phd/docs/phd_files/figure-html/unnamed-chunk-27-1.png")
```
---
...
.center[
<br>
**Question:** is this positive trend observed for a continuum of spatial scales? 
]
...
1. Understand the drivers of biodiversity changes

2. Predict the species richness

Predictions will allow me to fill the boxplot gaps, spatial and temporal gaps  
...
```{r, out.width="72%"}
knitr::include_graphics("../phd/docs/phd_files/figure-html/unnamed-chunk-128-1.png")
```
]
...
```{r, out.width="100%"}
knitr::include_graphics("../phd/RF/partial_plots/atlas_JPSP_fiveyears/AREA.jpg")
```
]
...
```{r, out.width="100%"}
knitr::include_graphics("../phd/RF/partial_plots/atlas_JPSP_fiveyears/time_span.jpg")
```
...
```{r, out.width="100%"}
knitr::include_graphics("../phd/RF/partial_plots/atlas_JPSP_fiveyears/double_partial/STAR.png")
```
...
```{r, out.width="100%"}
knitr::include_graphics("../phd/RF/partial_plots/atlas_plus_JPSP/double_partial/date_time.png")
```
]
...
<br>
* Compute the Species Richness trend for different spatial scales

<br>
* Add environmental covariates to understand at which scales they interact with biodiversity dynamic

<br>
* Explore the link with temporal scales

<br>
* Study other biodiversity metric

<br>
* Once the model is tailored for the Czech Republic, enlarge it to western europe
